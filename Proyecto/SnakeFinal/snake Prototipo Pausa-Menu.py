...
def pause (nivel,tiempo):
    ...
    while pausa:
        ...
        message_to_screen("Reanudar partida", white,x_displace=0, y_displace=0,size="small")
...
def gameLoop():
    ...
    while not gameExit:
        ...
        if vida==0 and gameOver==False and gameExit==False:
            Motor()
            gameOver=True
            ...
            if lead_x == randPortalX and lead_y == randPortalY:
                ...
                if nivel == 3:
                    ...
                    while ganaste == True:
                        ...
                        message_to_screen("Presiona Menú para salir", white,x_displace=0,y_displace=200,size="small")
                        display.update()
                        Led(1)
                        for event in pygame.event.get():
                            if event.type == pygame.QUIT:
